...
class Projectile extends Sprite {
    constructor(x, y, velocityX, velocityY, max, spell) {
        super(x, y, spell)
    ...
    draw() {
        ctx.drawImage(this.image, this.frames.val * this.image.width / 8, 0, this.image.width / 8, this.image.height, this.position.x - 80, this.position.y, this.image.width * 2 / 8, this.image.height * 2)
        // ctx.fillStyle = "black"
